...
public class RecentViewFragment extends FileBrowserViewFragment implements
    ...
    public void addSelectedFilesAndReload(ArrayList<FileInfo> files) {
    ...
    private void updateSelectedViewModel(ArrayList<FileInfo> files) {
        FragmentActivity activity = getActivity();
        if (activity != null) {
            FileSelectionViewModel viewModel = ViewModelProviders.of(activity).get(FileSelectionViewModel.class);
