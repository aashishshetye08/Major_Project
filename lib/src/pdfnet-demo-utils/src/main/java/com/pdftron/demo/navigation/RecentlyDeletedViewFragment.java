...
public class RecentlyDeletedViewFragment extends DialogFragment
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mToolbar.setTitle(R.string.recently_deleted);
    ...
    public void bindViews() {
        ...
        mTrashDurationTextView = mBinding.trashDurationMessage;
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mAdapter = new TrashAdapter(mTrashList, mItemSelectionHelper);
    ...
    private boolean handleOnItemClick(int position) {
        ...
        if (mActionMode == null) {
            ...
            if (activity instanceof AppCompatActivity) {
                mActionMode = mDelegate.startSupportActionMode(RecentlyDeletedViewFragment.this);
            }
            if (mActionMode != null) {
