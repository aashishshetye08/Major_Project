...
class CollabViewerTabImpl {
    ...
    public void showReplyFragment(@NonNull Fragment collabFragment,
        ...
        showReplyFragment(collabFragment, selectedAnnotId, authorId, selectedAnnotPageNum, documentId, tabTag, replyTheme, isNavigationListShowing, false);
    }
    ...
    public void showReplyFragment(@NonNull Fragment collabFragment,
        ...
        if (activity != null) {
            ...
            if (isNavigationListShowing) {
                ...
                BottomSheetReplyFragmentBuilder bottomSheetBuilder = builder.setDisableReplyEdit(disableReplyEdit).asBottomSheet();
