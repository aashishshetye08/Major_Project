...
public class ReplyHeader {
    ...
    private boolean disableReplyEdit;
    ...
    public ReplyHeader(@NonNull Context context, @NonNull Annot annot, boolean hasUnreadReplies, boolean hasAnnotList, boolean hasReviewState) {
        ...
        this.disableReplyEdit = false;
    }

    public ReplyHeader(@NonNull Context context, @NonNull Annot annot, boolean hasUnreadReplies, boolean hasAnnotList, boolean hasReviewState, boolean disableReplyEdit) {
        this.title = Utils.capitalize(AnnotUtils.getAnnotTypeAsString(context, getType(annot)));
        this.previewContent = getContents(annot);
        this.previewIcon = AnnotUtils.getAnnotImageResId(getType(annot));
        this.previewIconColor = AnnotUtils.getAnnotColor(annot);
        ...
        this.hasReviewState = hasReviewState;
        this.reviewState = null;
        this.disableReplyEdit = disableReplyEdit;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (disableReplyEdit != that.disableReplyEdit) return false;
        return reviewState == that.reviewState;
    }

    @Override
    public int hashCode() {
        return Objects.hash(title, previewContent, previewIcon, previewIconColor, previewIconOpacity, hasUnreadReplies, reviewState, commentEditable, disableReplyEdit);
    }
    ...
    public boolean isCommentEditable() {
        return commentEditable && !disableReplyEdit;
    }
    ...
    public static ReplyHeader updateUnreadReplies(@NonNull ReplyHeader oldReplyHeader, boolean hasUnreadReplies) {
        ...
        replyHeader.disableReplyEdit = oldReplyHeader.disableReplyEdit;
        return replyHeader;
    }
